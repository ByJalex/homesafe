...
<div class="container-fluid" id="stock">
    ...
    <div class="container mb-4 row">
        ...
        <div class="col-lg-3">
            <input type="text" placeholder="Buscar" v-model="searchStock" class="btn-block">
        </div>
        <div class="col-lg-6 d-flex justify-content-end">
            <button data-toggle="modal" data-target="#addStock" class="btn btn-info ml-4"><i class="fas fa-plus-square mr-2"></i>Agregar una marca</button>
            <a href="<?php echo RUTA_PADRE ?>privatesite/reportStock" target="_blank" class="btn btn-primary ml-4">Generar reporte</a>
        </div>
    </div>
                ...
                <div class="mb-5 ">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in filteredStock" v-show="(pag - 1) * NUM_RESULTS <= index  && pag * NUM_RESULTS > index">
                                    <td>{{item.cantidad}}</td>
                                    <td>{{item.nombre_p}}</td>
                                    <td>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination justify-content-end">
                            ...
                            <li class="page-item" v-show="pag * NUM_RESULTS / allStock.length < 1" @click.prevent="pag += 1">
...
<script src="../app/core/vue/admin/stock.js" type="text/javascript"></script>
