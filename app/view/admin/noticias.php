...
<div class="container-fluid" id="news">
    ...
    <div class="container mb-4 row">
        ...
        <div class="col-lg-3">
            <input type="text" placeholder="Buscar" v-model="searchNews" class="btn-block">
        </div>
                ...
                <div class="mb-5 ">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in filteredNew" v-show="(pag - 1) * NUM_RESULTS <= index  && pag * NUM_RESULTS > index">
                                    <td>{{item.titulo_noticia}}</td>
                                    <td>{{item.noticia}}</td>
                                    <td>{{item.imagen_n}}</td>
                                    <td>{{item.estado_noticia}}</td>
                                    <td>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination justify-content-end">
                            ...
                            <li class="page-item" v-show="pag * NUM_RESULTS / allNews.length < 1" @click.prevent="pag += 1">
...
<script src="../app/core/vue/admin/news.js" type="text/javascript"></script>
<?php
Page::footerTemplate();
?>