    ...
    <div class="row">
        <div class="col-lg-6">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                    <input class="form-control mt-3" type="text" placeholder="Nombre de la marca">
        ...
        <div class="col-lg-3">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">"Nombre de la marca"</h6>
                    </div>
                    <div class="card-body">
                    <div class="d-flex justify-content-star mt-3 mb-3"><img src="../../../public/images/xiaomi.png" alt="google" width="100px" class="img-fluid rounded-circle"></div>
                    <label for="nombre" class="mt-3 col-lg-12">Descripcion:</label>
                    </div>
                </div>
