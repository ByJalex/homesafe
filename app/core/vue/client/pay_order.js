const pay_order = new Vue({
    ...
    methods: {
        ...
        payOrder: function() {
            axios.get('https://homesafe-sv.herokuapp.com/api/sale/createsale?t=' + localStorage.getItem('t'))
                .then(response => (
        ...
        insertSale: function() {
            ...
            axios.post('https://homesafe-sv.herokuapp.com/api/sale/insertAllProducts?v=' + localStorage.getItem('i'), formData, {
                    headers: {
