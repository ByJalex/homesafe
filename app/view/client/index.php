  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 item-entry mb-4">
        <a href="product.php?id_prod=12" class="product-item md-height bg-gray d-block">
          <img src="../../../public/images/model_5.png" alt="Image" class="img-fluid">
        </a>
        <h2 class="item-title"><a href="product.php?id_prod=12">Google Wifi</a></h2>
        <strong class="item-price">$36.00</strong>
      ...
      <div class="col-lg-4 col-md-6 item-entry mb-4">
        <a href="#" class="product-item md-height bg-gray d-block">
          <img src="../../../public/images/prod_1.png" alt="Image" class="img-fluid">
        </a>
        <h2 class="item-title"><a href="#">Google Nest</a></h2>
        <strong class="item-price">$149.00</strong>
        <div class="star-rating">
          <span class="icon-star2 text-warning"></span>
          <span class="icon-star2 text-warning"></span>
          <span class="icon-star2 text-warning"></span>
      ...
      <div class="col-lg-4 col-md-6 item-entry mb-4">
        ...
        <h2 class="item-title"><a href="#">Google Wifi</a></h2>
        <strong class="item-price">$36.00</strong>
